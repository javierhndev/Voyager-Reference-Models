...
##########################################################################################
# Example: Pretraining phase 1 of BERT with 5B parameters on multinode with 8 card each
##########################################################################################
...
MODEL_CONFIG=$MODEL_PATH/scripts/bert_5b_config.json
DS_CONFIG=$MODEL_PATH/scripts/deepspeed_config_bert_5b_lans.json
RESULTS_DIR=$MODEL_PATH/results/bert_5b_lans
MAX_SEQ_LENGTH=128
